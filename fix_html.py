...
new_wrapper_html = f'''        <div class="testi-marquee-wrapper">
            <div class="testi-fade-left"></div>
            <div class="testi-fade-right"></div>
...
# regex replace
pattern = r'        <div class="testi-marquee-wrapper">.*?    <!-- Demo Placeholder Section -->'
new_content = re.sub(pattern, new_wrapper_html, content, flags=re.DOTALL)
